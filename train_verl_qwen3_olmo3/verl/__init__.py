...
# ---------------------------------------------------------------------------
# Lazy export: DataProto (and its dependency `ray`) are only needed for training
# workflows. Importing `verl` should not hard-require `ray`, because many
# utilities (e.g. dataset preprocessing / prompt validation scripts) only need
# the dataset and tokenizer stack.
# ---------------------------------------------------------------------------
