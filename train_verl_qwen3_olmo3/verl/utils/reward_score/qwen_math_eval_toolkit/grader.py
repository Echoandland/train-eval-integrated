"""
Math equivalence checker used for reward computation.

This logic is adapted from the Hendrycks' MATH release (math_equivalence), and
similar to implementations in:
...
def choice_answer_clean(pred: str):
    """Normalize multiple-choice style answers like 'A', 'B', ..."""
...
def numeric_equal(prediction: float, reference: float):
    # numerical closeness with relative tolerance
