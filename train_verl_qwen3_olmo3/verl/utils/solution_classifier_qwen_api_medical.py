...
# NOTE:
# Removed old commented-out snippets that referenced absolute, repo-local paths.
"""
Solution classification using GPT-4 for grouping similar mathematical solutions.
"""
import logging
...
class Entropy_Calculation_Classify_By_Qwen:
    ...
    def analyze_solutions_with_qwen(self, n_solutions):
        try:
            ...
            # user_input = (
            #     "Here are several solutions to the same question:" + str_solutions +
            #     "You are an expert medical solution classifier. Your task is to analyze different approaches to medical problems and categorize them into meaningful groups that capture their fundamental similarities and differences."
            #     "When presented with multiple solutions to a medical problem, analyze each approach to understand its core methodology. Then create a single classification system that groups solutions based on their most fundamental shared characteristics. Explain why you chose this particular way of categorizing the solutions and how each solution fits into your classification."
            #     "Please analyze and determine how these solutions can be grouped based on the methods they use. "
            #     "Your classification criteria must remain strictly high-level. Place solutions in different categories only when their overarching strategies are completely distinct; differences limited to sub-steps or implementation details do not count as high-level distinctions."
            #     "Before you begin grouping, clearly state the classification criteria you will follow. "
            #     "In your response, focus on explaining your reasoning and clearly state which solution indices should be grouped together. "
            ...
            #     "In your grouping, each solution should be assigned to exactly one of the groups. Make sure to carefully check the total number of solutions."
            #     "Here is an Example Answer: \nHigh-level method used\n\n"
            #     "Group 1 – Medication-Centered Approaches \n"
            #     "• Solution 1 \n"
            #     "• Solution 3 \n\n"
            #     "These solutions prioritize pharmacological intervention as the primary tool for glucose control. Solution 1 uses the standard stepwise medication approach, while Solution 3 employs intensive insulin therapy. Both rely fundamentally on drugs to achieve glycemic targets, with other interventions being secondary.\n\n"
            #     "Group 2 – Lifestyle-Centered Approaches \n"
            #     "• Solution 2 \n"
            #     "• Solution 4 \n\n"
            #     "These solutions emphasize non-pharmacological interventions as the primary treatment modality. Solution 2 uses a structured, comprehensive lifestyle program, while Solution 4 focuses on dietary and behavioral modifications. Both believe that lifestyle changes should be the foundation of diabetes management.\n\n"
            #     "Group 3 – Assessment-Centered Approach \n"
            #     "• Solution 5 \n\n"
            #     "This solution prioritizes comprehensive evaluation and risk stratification before determining treatment. Rather than immediately implementing a specific intervention, it focuses on gathering information to guide personalized decision-making.\n\n"
            #     "Thus every solution belongs to exactly one of three distinct groups:\n"
            #     "• Group 1: 1, 3 \n"
            #     "• Group 2: 2, 4 \n"
            #     "• Group 3: 5"
            ...
            user_input = (
                ...
                "Note that if all solutions use entirely different approaches, each should be placed in its own distinct group. "
                "In your grouping, each solution should be assigned to exactly one of the groups. Make sure to carefully check the total number of solutions."
                # "Here is an Example Answer，but you are not limited to this specific way of grouping: \nHigh-level method used\n\n"
                # "Group 1 – Pattern-Based Recognition \n"
                # "• Solution 1 \n"
                # "• Solution 2 \n\n"
                # "These approaches rely on recognizing familiar clinical patterns and prior similar cases (e.g., abdominal wall endometriosis given cesarean history; desmoid tumor given rectus location and demographics).\n\n"
                # "Group 2 – Systematic Investigation \n"
                # "• Solution 3 \n"
                # "• Solution 4 \n\n"
                # "These approaches employ methodical, step-by-step workups (protocol-driven imaging characterization, tissue sampling, and immunohistochemistry/staging) before concluding.\n\n"
                # "Thus every solution belongs to exactly one of two distinct groups:\n"
                # "• Group 1: 1, 2 \n"
                # "• Group 2: 3, 4"
                # )
                "Here is the format you should follow: High-level method used\n\n"
                "Group 1 – <GROUP_1_NAME>\n"
                "• Solution <ID>\n"
                "• Solution <ID>\n\n"
                "<ONE_SENTENCE_RATIONALE_FOR_GROUP_1>\n\n"
                "Group 2 – <GROUP_2_NAME>\n"
                "• Solution <ID>\n"
                "• Solution <ID>\n\n"
                "<ONE_SENTENCE_RATIONALE_FOR_GROUP_2>\n\n"
                "Thus every solution belongs to exactly one of two distinct groups:\n"
                "• Group 1: <ID_LIST>\n"
                "• Group 2: <ID_LIST>"
                )
