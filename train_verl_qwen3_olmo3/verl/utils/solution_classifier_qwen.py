...
# NOTE:
# The original upstream file contained an ad-hoc, repo-local test runner that read/wrote
# absolute paths. Those paths are not valid in this repo and can cause accidental
# execution on import. We intentionally remove that block here.