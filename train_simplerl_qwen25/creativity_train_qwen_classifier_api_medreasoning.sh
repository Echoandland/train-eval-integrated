...
export SOLUTION_CLASSIFIER=${SOLUTION_CLASSIFIER:-qwen_api_medical}
BASE_CONFIG="\
...
TRAIN_FILE="huggingface/medcase_qwen/train_last3000.chatml.parquet"
# VAL_FILE="huggingface/medcase_qwen/test.parquet"
VAL_FILE="huggingface/medcase_qwen/val_50.chatml.parquet"

# 初始模型路径
# MODEL_PATH="hkust-nlp/Qwen-2.5-7B-SimpleRL-Zoo"
# MODEL_PATH="Qwen/Qwen2.5-7B-Instruct"
# MODEL_PATH="/home/zhiyuan/yc/ms-swift/output/qwen2p5-med-sft-full/v2-20250924-061303/checkpoint-150"
MODEL_PATH="Echoandland/qwen2.5-7b-instruct-medcasereasoning-sft-full-params-step150"
# MODEL_PATH="/home/zhiyuan/yc/ms-swift/output/qwen2p5-med-sft/v3-20250923-054318/checkpoint-180-merged"
EXPERIMENT_NAME="15Oct_testing_medcase_reasoning"
