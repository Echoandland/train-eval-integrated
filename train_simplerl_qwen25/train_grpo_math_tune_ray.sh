...
# You should make sure the following paths are correct
export PROJECT_NAME=Creativity-RL
export WANDB_API_KEY=207e3c8f6d752b1e68a95e5a925b816907765438
export WANDB_OFFICIAL=1
export VLLM_ATTENTION_BACKEND=XFORMERS
export HDFS_DATA_PATH=./huggingface
export HDFS_MODEL_PATH=Qwen
export HDFS_CHECKPOINT_PATH=./ckpt
export HDFS_LOG_PATH=./logs
export RUN_NAME=verl-grpo
export ARNOLD_WORKER_NUM=1 # number of nodes you want to use 
export HEAD_IP=172.28.180.222
export HEAD_PORT=6382
