...
export SOLUTION_CLASSIFIER=${SOLUTION_CLASSIFIER:-qwen_api_physics}
BASE_CONFIG="\
...
TRAIN_FILE="huggingface/textbookreasoning/utils/train.parquet"
VAL_FILE="huggingface/textbookreasoning/utils/test.parquet"

# 初始模型路径
# MODEL_PATH="hkust-nlp/Qwen-2.5-7B-SimpleRL-Zoo"
MODEL_PATH="Qwen/Qwen2.5-3B-Instruct"
EXPERIMENT_NAME="megascience_physics_qwen3binstruct_10Sep_testing"
